...
function solarDay(SY,SM,SD) {
    var sTermInfo = new Array(0, 21208, 42467, 63836, 85337, 107014, 128867, 150921, 173149, 195551, 218072, 240693, 263343, 285989, 308563, 331033, 353350, 375494, 397447, 419210, 440795, 462224, 483532, 504758)
    var solarTerm = new Array("小寒", "大寒", "立春", "雨水", "惊蛰", "春分", "清明", "谷雨", "立夏", "小满", "芒种", "夏至", "小暑", "大暑", "立秋", "处暑", "白露", "秋分", "寒露", "霜降", "立冬", "小雪", "大雪", "冬至")
    var  sFtv = new Array("0101 元旦", "0214 情人节", "0308 妇女节", "0312 植树节", "0401 愚人节", "0501 劳动节", "0504 青年节", "0512 护士节", "0601 儿童节", "0701 建党节", "0801 建军节", "0910 教师节", "1001 国庆节", "1101 万圣节","1225 圣诞节", "0513 母亲节", "0617 父亲节")
...
function BasicView(element, calendar, viewName) {
	...
	function buildCellHTML(date) {
		...
		if (showNumbers) {
			//增加阴历
			var scs=solarDay(date.getFullYear(),date.getMonth(),date.getDate());
			html += "<div class='fc-day-number'>" + date.getDate() + "<br/>" + scs + "</div>";
		}
